...
| 030 | [030-pm3-paper-mill-pipeline.md](030-pm3-paper-mill-pipeline.md) | PM3 학술 논문 자동화 파이프라인 아키텍처 | 2026-03-01 |
...
| 043 | [043-ssk-cc-full-handover.md](043-ssk-cc-full-handover.md) | SSK 논문 cc 전면 이관 — 55+ 리뷰어 자동화 | 2026-03-16 |
...
| 048 | [048-sc41-canvas-lms-automation.md](048-sc41-canvas-lms-automation.md) | SC41 학교생활 자동화 — Canvas LMS + cron | 2026-03-03 |
| 049 | [049-syncthing-tailscale-two-pc-sync.md](049-syncthing-tailscale-two-pc-sync.md) | Syncthing + Tailscale 서울-세종 PC 동기화 | 2026-02-20 |
...
| 062 | [062-trojan-horse-strategy-ssk.md](062-trojan-horse-strategy-ssk.md) | SSK 트로이목마 전략 — 학술지+학부 이중 산출물 | 2026-03-17 |
| 063 | [063-adr-전수-마이그레이션-완료-총-62건.md](063-adr-전수-마이그레이션-완료-총-62건.md) | ADR 전수 마이그레이션 완료 — 총 62건 | 2026-03-19 |
| 064 | [064-adr-018-026-과거-전체-커밋-소급-총-26건-완성.md](064-adr-018-026-과거-전체-커밋-소급-총-26건-완성.md) | ADR 018-026 과거 전체 커밋 소급 — 총 26건 완성 | 2026-03-19 |
| 065 | [065-adr-011-017-adr_auto-py-자동-생성-세션-종료-훅.md](065-adr-011-017-adr_auto-py-자동-생성-세션-종료-훅.md) | ADR 011-017 + adr_auto.py 자동 생성 + 세션 종료 훅 | 2026-03-19 |
| 066 | [066-architecture-integrity-한글-툴팁-추가-마우스-호버로-설명-표시.md](066-architecture-integrity-한글-툴팁-추가-마우스-호버로-설명-표시.md) | Architecture+Integrity 한글 툴팁 추가 | 2026-03-19 |
| 067 | [067-새로고침-런체크-합침-새로고침-시-무결성-검증도-같이-실행.md](067-새로고침-런체크-합침-새로고침-시-무결성-검증도-같이-실행.md) | 새로고침+런체크 합침 | 2026-03-19 |
| 068 | [068-adr-슬러그-파일명-매칭-t9bot-ntfs-lock-우회.md](068-adr-슬러그-파일명-매칭-t9bot-ntfs-lock-우회.md) | ADR 슬러그 파일명 매칭 + t9bot NTFS lock 우회 | 2026-03-19 |
| 069 | [069-t9-dashboard-전면-리팩터링-projects-제거-역할-분리-툴팁.md](069-t9-dashboard-전면-리팩터링-projects-제거-역할-분리-툴팁.md) | T9 Dashboard 전면 리팩터링 | 2026-03-17 |

## Proposed (보류)

| # | 파일 | 결정 | 날짜 | 사유 |
|---|------|------|------|------|
| 047 | [047-odnar-supabase-nextjs-mvp.md](047-odnar-supabase-nextjs-mvp.md) | ODNAR MVP 기술 스택 — Next.js + Supabase + Three.js | 2026-02-24 | ODNAR 방향성 위기 (2026-03-19). 정의 미확정, 한빈 방향 결정 대기 |

| 063 | [063-새로고침-런체크-합침-새로고침-시-무결성-검증도-같이-실행.md](063-새로고침-런체크-합침-새로고침-시-무결성-검증도-같이-실행.md) | 새로고침+런체크 합침 — 새로고침 시 무결성 검증도 같이 실행 | 2026-03-19 |

## Superseded (대체됨)

| # | 파일 | 결정 | 날짜 | 대체 ADR |
|---|------|------|------|----------|
| 028 | [028-l2u-to-t9agent-telegram.md](028-l2u-to-t9agent-telegram.md) | L2U watcher 폐기 → T9 Agent 텔레그램 봇 전환 | 2026-03-06 | ADR-034 (Python 재작성) |
...
| # | 파일 | 결정 | 날짜 | 사유 |
|---|------|------|------|------|
| 036 | [036-finbot-model-switch-qwen.md](036-finbot-model-switch-qwen.md) | FinBot 모델 변경 — DeepSeek → Qwen2.5 | 2026-03-16 | T-SUM/FinBot 프로젝트 보류, 결정 무효 |
