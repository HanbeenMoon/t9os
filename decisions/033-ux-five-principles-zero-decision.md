...
- 이유: PKM 도구 연구에서 "캡처 시 분류를 요구하면 캡처율이 급락" 확인. 한빈 피드백 "UX가 나빠서 안 쓰게 된다"에 대응. Steve Krug "Don't Make Me Think", Calm Technology 원칙 참조.
- 대안: 기존 CLI 명령어 체계 유지 (진입장벽 높음), GUI 대시보드 개발 (Build vs Buy 위반)
- 결과: UX_PRINCIPLES.md 생성, L1에 "한빈 메시지 우선/UX 우선/맥락 이해 우선" 규칙 추가
