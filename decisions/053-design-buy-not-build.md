...
- 날짜: 2026-03-17
- 상태: 채택됨
- 결정: 디자인 작업은 v0.dev API 등 외부 도구를 사용한다(Buy). cc가 직접 Three.js 코드로 디자인을 생성하는 것을 금지한다. ODNAR Three.js 홈페이지는 cx(Codex)가 생성하되, 디자인 품질은 G7(디자인 감시단)이 검증한다.
...
- 출처: memory/feedback_design_buy_not_build.md, 20260307_CX_008_(ODNAR)_103847_인터랙티브홈페이지Threejs구현.txt
