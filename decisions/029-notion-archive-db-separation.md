...
- 결정: Notion의 legacy-bot 작업큐 DB(faed81d1)와 결과 아카이브를 분리한다. 새 아카이브 전용 DB(31be6a3c-9e5a-8163)를 생성하고, 에이전트 실행 결과는 아카이브 DB에만 기록한다.
...
- 출처: 20260306_CX_021_(2-legacy-bot)_233940_NotionArchiveDB분리및롤백체계구축.txt
