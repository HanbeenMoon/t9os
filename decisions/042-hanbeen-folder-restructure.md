# ADR-042: HANBEEN 폴더 구조 표준화 — PROJECTS/PERSONAL/_ai/_keys 4분할

- 날짜: 2026-02-20 (초기 설정), 2026-02-21 (전수조사+정리)
- 상태: 채택됨
- 결정: HANBEEN 루트를 PROJECTS/(개발 프로젝트), PERSONAL/(학교/개인), _ai/(AI 로그+도구), _keys/(비밀키)로 4분할한다. 심볼릭 링크(~/code/HANBEEN → /mnt/c/Users/winn/HANBEEN)로 WSL 접근을 단축한다. FOR_AI, FOR_ME, dev 등 초기 폴더는 이 구조로 통합/폐기한다.
